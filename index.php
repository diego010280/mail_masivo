...
<head>
	...
	<link rel="stylesheet" type="text/css" href="public\css\style.css?=v=2.2.1">
		...
		<nav id="navbar" class="navbar fixed-top navbar-expand-lg navbar-header navbar-mobile">
			<div class="navbar-container container">
				...
				<div class="collapse navbar-collapse justify-content-around" id="navbarNav">
					...
					<ul class="navbar-nav">
						<li class="nav-item">
							<a class="nav-link learn-more-btn"  href="#" data-toggle="modal" data-target="#myModal" role="button">Signup</a>
						</li>
					</ul>
				</div>
			</div>
